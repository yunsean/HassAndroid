...
class HttpApi(private val haHost: String): Api {
    ...
    override fun gpsLogger(latitude: Double, longitude: Double, altitude: Double, address: String?, device: String, accuracy: String, provider: String, battery: Float, batteryTemperature: Float, isCharging: Boolean, isInteractive: Boolean, wifi: String?, currentApp: String?, gpsPassword: String?): Observable<String> = restApi.gpsLogger(haPassword, haToken, latitude, longitude, altitude, address, device, accuracy, provider, battery, batteryTemperature, isCharging, isInteractive, wifi, currentApp, gpsPassword)
